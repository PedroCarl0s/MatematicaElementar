    ...
    public LicensesWedge(XmlResourceParser parser) throws XmlPullParserException, IOException {
        ...
        if (showDefaults) {
            addChild(new LicenseWedge(
                            "PedroCarl0s/MatematicaElementar",
                            "Matemática Elementarr",
                            "Aplicativo com foco em auxiliar a resolução de exercícios de Matemática Elementar, a partir da resolução com passo a passo.",
                            "Apache License 2.0",
                            null,
                            "https://github.com/PedroCarl0s/MatematicaElementar",
                            null,
                            null,
                            null,
                            null,
